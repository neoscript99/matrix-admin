...
abstract class AbstractDataInitializerRunner implements CommandLineRunner {
     ...
     * @param pattern
     */
    void doInit(com.feathermind.matrix.repositories.GeneralRepository generalRepository, ApplicationContext applicationContext, String basePackage, String pattern = "**/*.class") {
